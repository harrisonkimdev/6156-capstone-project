...
def test_generate_segment_report(monkeypatch, tmp_path: Path) -> None:
    ...
    def fake_segment_video_from_manifest(path):
        return [type("Seg", (), {"start_time": 0.0, "end_time": 0.5, "label": "movement", "frame_indices": (0, 1), "duration": 0.5})]
    ...
    monkeypatch.setattr("pose_ai.service.segment_report.segment_video_from_manifest", fake_segment_video_from_manifest)
