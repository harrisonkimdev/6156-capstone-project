#!/usr/bin/env python3
"""Test frame extraction without pose estimation."""
...
output_root = Path('data/workflow_frames/test_simple')

print(f'Video exists: {video_path.exists()}')
print(f'Starting extraction WITHOUT pose similarity...')
...
try:
    result = extract_frames_with_motion(
        ...
        use_pose_similarity=False,  # Disable pose estimation
        write_manifest=True,
        overwrite=True,
    )
